  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.teams}>
        <Team image={Carta1} onPress={() => {var newScore = time1 + 1; setTime1(newScore); checkForWinner (newScore, "time1")}} points={time1} />
        <Team image={Carta2} onPress={() => {var newScore = time2 + 1; setTime2(newScore); checkForWinner (newScore, "time2")}} points={time2} />
      </View>
    </View>
  );
}
